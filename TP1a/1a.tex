\toptitle{[ELEC-H-201] Électricité et électronique}{TP1a}
\TPtitle{Électricité et électronique\vspace*{2mm}}{TP1a:\vspace*{2mm}
Circuits résistifs avec sources de tension continue}

\frontpage{consignes1a.tex}
\vspace{5cm}
\newpage
...
% Cet exercice utilise la méthode prédiction-calculs-interprétations des résultats et comparaison des résultats obtenus avec les prédictions.\\
...
% \begin{center}
% \begin{circuitikz} \draw
% (0,0)   to[battery1, l=$E_{totale_{equivalente}}$, invert] (0,3)--(2,3)
% (0,0)--(2,0) to[R, l_=$R_{totale_{equivalente}}$] (2,3)
% ;
% \end{circuitikz}
% \end{center}
...
\section{Exercice 5}\ifthenelse{\boolean{assistant}}
{\color{blue} Exercice prioritaire \\ Timing: 15min \\ \color{black}}{}
...
Soit le circuit suivant où toutes les sources sont égales à $10V$ et toutes les résistances à $10\Omega$:
\begin{center}
\begin{circuitikz} \draw
